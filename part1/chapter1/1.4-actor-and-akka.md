...
简介：Akka是JAVA虚拟机JVM平台上构建高并发、分布式和容错应用的工具包。Akka用Scala语言写成，同时提供了Scala和JAVA的开发接口。官网：[https://akka.io](https://akka.io/)
...
我们把Actors当作是一个人，这个人不会直接说话，他们只通过mail来进行交流【发送消息】。  
Actors的一些特性：
